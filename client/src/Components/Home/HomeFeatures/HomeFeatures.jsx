            ...
            <div className="features__list container">
                <div className="row">
                    <div className="col-md-4">
                        <IndividualFeature featureName="History Record of Answered Questions" imgSrc={HistoryFeature}/>
                    </div>
                    <div className="col-md-4">
                        <IndividualFeature featureName="Voice to Text Conversion of Answers" imgSrc={voiceText}/>
                    </div>
                    <div className="col-md-4">
                ...
                <div className="row">
                    <div className="col-md-6">
                        <IndividualFeature featureName="Set Timer for Doubt Clearance Session" imgSrc={timerDoubt}/>
                    </div>
                    <div className="col-md-6">
